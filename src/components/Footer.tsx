				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8'>
					...
					<div className='lg:col-span-2'>
						<div className='flex items-center mb-4'>
							...
							<h3 className='text-xl font-bold'>Accer School</h3>
						</div>
						<p className='text-gray-300 leading-relaxed mb-4 text-sm lg:text-base'>
							Menciptakan generasi masa depan melalui pendidikan berkualitas dengan kurikulum
							inovatif, fasilitas modern, dan pengembangan karakter yang mempersiapkan siswa
					...
					<div>
						...
						<div className='space-y-3 text-sm'>
							<div className='flex items-start'>
								<svg
									className='w-4 h-4 mt-1 mr-3 text-blue-400 flex-shrink-0'
									fill='currentColor'
									viewBox='0 0 20 20'
								>
									<path
							...
							<div className='flex items-center'>
								...
								<p className='text-gray-300'>info@accerschool.com</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div className='flex flex-col md:flex-row justify-between items-center'>
						<div className='mb-4 md:mb-0'>
							<p className='text-gray-400 text-sm'>
								&copy; {new Date().getFullYear()} Accer School. Semua hak cipta dilindungi.
							</p>
						</div>
